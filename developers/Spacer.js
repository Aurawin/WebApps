coDevelopersPage.App.Components.Spacer = {
  Version        : new Version(2014,1,11,1),
  Title          : new Title("Developer Views Spacer","Spacer"),
  ...
  Header         : coAppKit.Dependencies.Create(coDevelopersPage.App,'/developers/Spacer.js',coAppKit.PreLoaded),
  debugToConsole : true,
