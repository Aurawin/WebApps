coDevelopersPage.App.Components.Data= {
  Version        : new Version(2014,10,13,5),
  Title          : new Title("Developer Views Data","Data"),
  ...
  Header         : coAppKit.Dependencies.Create(coDevelopersPage.App,'/developers/Data.js',coAppKit.PreLoaded),
  debugToConsole : true,
  ...
  setContent : function(Screen,ShowCase,Item){
    ...
    cb.CMS.setURI("/developers/Data.xml");
  }
};
