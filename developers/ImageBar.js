coDevelopersPage.App.Components.ImageBar = {
  Version        : new Version(2014,1,11,1),
  Title          : new Title("Developer Views Image Bar","Image Bar"),
  ...
  Header         : coAppKit.Dependencies.Create(coDevelopersPage.App,'/developers/ImageBar.js',coAppKit.PreLoaded),
  debugToConsole : true,
  Create : function(Owner){
    ...
    vs.LoadContent=function(){
      var vs=this;
      coDOM.httpGET(vs,coDevelopersPage.App.Components.Content.urlProgramText,vs.onContentLoaded,vs.onContentError);
