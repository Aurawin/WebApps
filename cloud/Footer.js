coCloudPage.App.Components.Footer = {
  Version        : new Version(2014,1,7,1),
  Title          : new Title("Cloud Views Footer","Footer"),
  ...
  Header         : coAppKit.Dependencies.Create(coCloudPage.App,'/cloud/Footer.js',coAppKit.PreLoaded),
  debugToConsole : true,
  urlContent     : '/cloud/cntFooter.html',
  Init : function(){
