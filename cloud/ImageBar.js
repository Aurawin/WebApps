coCloudPage.App.Components.ImageBar = {
  ...
  Header         : coAppKit.Dependencies.Create(coCloudPage.App,'/cloud/ImageBar.js',coAppKit.PreLoaded),
  debugToConsole : true,
  urlProgramText : '/cloud/cntImageBar.html',
